...
public sealed class QueueOptions
{
    ...
    [Range(1, 299)] public int RepeatCallAnnouncementSeconds { get; init; } = 20;
    [Range(1, 300)] public int CalledDisplaySeconds { get; init; } = 40;
    public string[] ExcludedConsultorios { get; init; } = [];
